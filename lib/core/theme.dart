...
/// خط واجهة التطبيق.
///
/// **Cairo** موحّداً على **كل** المنصات بلا استثناء — موبايل وويب
/// وويندوز وماك ولينكس — لقاء خطه العربي المتوازن وقراءته العالية في
/// الأحجام الصغيرة، ولأنه مضمّن محلياً فلا يتبدّل المظهر بين منصة وأخرى.
///
/// الخط مضمّن محلياً في `assets/fonts/Cairo-*.ttf` (لا `google_fonts`
/// ولا أي سحب عبر الشبكة) فيعمل التطبيق بالكامل دون اتصال بنسبة 100%،
/// **بما فيه ويندوز** — فلا اعتماد على أي خط مثبّت في النظام.
/// الأوزان المضمّنة: 400 Regular، 500 Medium، 600 SemiBold، 700 Bold.
/// رخصة Cairo: SIL Open Font License 1.1 — `assets/fonts/OFL-Cairo.txt`.
String? get uiFontFamily => 'Cairo';
