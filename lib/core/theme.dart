...
/// خط واجهة التطبيق.
///
/// **Cairo** على كل المنصات (موبايل/ويب/ماك/لينكس) لقاء خطه العربي
/// المتوازن وقراءته العالية في الأحجام الصغيرة، و**يُترك ويندوز على خطه
/// الافتراضي** بلا تبديل — بطلب صريح: نسخة الويندوز لا تُمس.
///
...
String? get uiFontFamily =>
    (!kIsWeb && Platform.isWindows) ? null : 'Cairo';
